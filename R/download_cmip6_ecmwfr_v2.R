...
#' 'ssp585' are the only legit options, which are also the standard scenarios 
#' of CMIP6
#' 
...
#' 
#' @param sec_wait numeric, sets the maximum waiting time per requested file. By default is 3600, so 1 hour
#' 
...
#' 
#' @param path_download character, sets the path for the download of the CMIP6 file. If not already present, then a 
